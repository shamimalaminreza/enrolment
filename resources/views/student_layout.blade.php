...
$student_profile=DB::table('student_tbl')->where('student_id',$student_id)->first();
    ...
    <div class="container-fluid page-body-wrapper">
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            <div class="profile">
              <img src="{{URL::to($student_profile->student_image)}}" height="70" width="100" style="border-radius: 50%">
          ...
          <ul class="nav">
           ...
           <a class="nav-link" href="{{URL::to('/student_profile')}}">
             ...
             <a class="nav-link" href="{{URL::to('/student_seeting')}}">
                <i class="mdi mdi-gauge menu-icon"></i>
                <span class="menu-title">Seeting</span>
              </a>

 <a class="nav-link" href="{{URL::to('/student_logout')}}" onclick="return confirm('Are you want to logout');">
                <i class="mdi mdi-gauge menu-icon"></i>
