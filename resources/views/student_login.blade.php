    ...
    <div class="container-fluid page-body-wrapper">
      <div class="row">
        <div class="content-wrapper full-page-wrapper d-flex align-items-center auth-pages">
         ...
         <input type="text" class="form-control p_input" name="student_email" placeholder="email"  required="">
                </div>
                <div class="form-group">
                  <label>Password *</label>
    <input type="text" class="form-control p_input" name="student_password" placeholder="password" required="">
                </div>
