...
$admin_profile=DB::table('admin_tbl')->where('admin_id',$admin_id)->first();
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center">
        ...
        <div class="dropdown-menu navbar-dropdown mail-notification" aria-labelledby="MailDropdown">
              ...
              <a class="dropdown-item" href="{{URL::to('/seeting')}}">
                <div class="sender-img">
                ...
                <div class="sender">
                  <p class="Sende-name">Seeting</p>
                </div>
              </a>

<!--onclick="return confirm('Are you want to logout')"-->
       <a class="dropdown-item" href="{{URL::to('/logout')}}" onclick="return confirm('Are you want to logout')">
                <div class="sender-img">
            <img src="http://via.placeholder.com/47x47" alt="">
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            ...
            <div class="details">
              <p class="user-name">{{$admin_profile->admin_name}}</p>
            </div>
          </div>
          <ul class="nav">
            <!--main pages start-->
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="advancedSubmenu">
                <ul class="nav flex-column sub-menu">
  <li class="nav-item"><a class="nav-link" href="{{URL::to('/add_teacher')}}">Add teacher</a></li>

  <li class="nav-item"><a class="nav-link" href="{{URL::to('/allteacher')}}">All teacher</a></li>
...
<script>
       ...
       //
        $(document).on("click","#view",function(e) {
          e.preventDefault();
          var link=$(this).attr("href");
          bootbox.confirm("Are you sure to view?",function(confirmed){
              if (confirmed) {
                   window.location.href=link;
              };
          });
...
<script>
       ...
       //
        $(document).on("click","#edit",function(e) {
          e.preventDefault();
          var link=$(this).attr("href");
          bootbox.confirm("Are you sure to edit?",function(confirmed){
              if (confirmed) {
                   window.location.href=link;
              };
          });
